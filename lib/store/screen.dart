    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Padding(padding: EdgeInsets.only(top: sdp_fromPX(context, 70))),
          Padding(
          ...
          Row(
            ...
            children: [
              ...
              if (trclassText != null) Padding(padding: EdgeInsets.only(left: sdp_fromPX(context, 330))),
              Row(
                children: [
                  Text(categoryText!,
                      style: TextStyle(fontSize: sdp_fromPX(context, 43), fontWeight: FontWeight.w500, foreground: Paint()..shader = whiteGradient)),
                  Padding(padding: EdgeInsets.only(left: sdp_fromPX(context, 10))),
                  if (trclassText != null)
                    ShaderMask(
          ...
          Padding(padding: EdgeInsets.only(top: sdp_fromPX(context, 40))),
          Container(
            height: sdp_fromPX(context, type == 1 || type == 4 ? 740 : 570),
            child: Stack(
              children: [
                Container(
