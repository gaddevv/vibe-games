                ...
                child: Column(children: [
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(
                            top: sdp_fromPX(context, 61),
                            left: sdp_fromPX(context, 100)),
                        child: RichText(
                          text: TextSpan(
                            text: 'Красное',
                            style: TextStyle(
                                color: Color.fromRGBO(151, 43, 48, 1),
                      ...
                      Column(
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                top: sdp_fromPX(context, 7),
                                left: sdp_fromPX(context, 365)),
                            child: Text(
                  ...
                  Row(
                    children: [
                      Padding(
                        padding:
                            EdgeInsets.only(left: sdp_fromPX(context, 100)),
                        child: Column(
                          children: [
                            Padding(
                              padding: EdgeInsets.only(
                                ...
                                childWidget: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        ...
                                        color:
                                            Color.fromRGBO(113, 56, 184, 0.3)),
                                  ),
                                  child: Padding(
                                    padding:
                                        EdgeInsets.all(sdp_fromPX(context, 5)),
                                    child: Container(
                                      decoration: BoxDecoration(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ButtonAnimator(
                          ...
                          childWidget: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius:
                                  BorderRadius.circular(sdp_fromPX(context, 5)),
                            ),
                            child: Center(
                              child: Text(
                                'Точное число',
                                style: TextStyle(
                                    color: Color.fromRGBO(255, 255, 255, 1),
                                    fontSize: sdp_fromPX(context, 23),
                                    fontWeight: FontWeight.w400),
                              ),
                            ),
                          ),
                        ...
                        Padding(
                            padding:
                                EdgeInsets.only(left: sdp_fromPX(context, 50))),
                        ButtonAnimator(
                          onTap: () {},
                          childWidget: Container(
                            height: sdp_fromPX(context, 63),
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        top: sdp_fromPX(context, 55),
                        left: sdp_fromPX(context, 90)),
                    child: Text(
                      ...
                      Padding(
                        ...
                        child: ButtonAnimator(
                          ...
                          childWidget: Container(
                            ...
                            decoration: BoxDecoration(
                                color: activeStop
                                    ? Color.fromRGBO(184, 53, 53, 0.4)
                                    : Color.fromRGBO(184, 53, 53, 0.8),
                                borderRadius: BorderRadius.circular(
                                    sdp_fromPX(context, 5)),
                                border: Border.all(
                                    width: sdp_fromPX(context, 2),
                                    color: Color.fromRGBO(184, 53, 53, 0.4))),
                            child: Center(
                              child: Text(
                                'Отмена',
                                style: TextStyle(
                            ...
                            decoration: InputDecoration(
                              ...
                              enabledBorder: OutlineInputBorder(
                                ...
                                borderSide: BorderSide(
                                    width: sdp_fromPX(context, 2),
                                    color: Color.fromRGBO(60, 21, 111, 0.95)),
                              ),
                      ...
                      Padding(
                        ...
                        child: ButtonAnimator(
                          ...
                          childWidget: Container(
                            ...
                            decoration: BoxDecoration(
                                color: activeStart
                                    ? Color.fromRGBO(55, 161, 98, 0.4)
                                    : Color.fromRGBO(55, 161, 98, 0.8),
                                borderRadius: BorderRadius.circular(
                                    sdp_fromPX(context, 5)),
                                border: Border.all(
                                    width: sdp_fromPX(context, 2),
                                    color: Color.fromRGBO(55, 161, 98, 0.4))),
                            child: Center(
                              child: Text(
                                'Играть',
                                style: TextStyle(
