              ...
              child: Center(
                ...
                child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsets.only(
                                top: sdp_fromPX(context, 67),
                                left: sdp_fromPX(context, 85)),
                            child: Text(
                              '“Больше - меньше”',
                              style: TextStyle(
                                  color: Color.fromRGBO(255, 255, 255, 1),
                                  fontSize: sdp_fromPX(context, 35),
                                  fontWeight: FontWeight.w700),
                            ),
                          ),
                          Padding(
                            padding:
                                EdgeInsets.only(left: sdp_fromPX(context, 123)),
                          ),
                          Column(
                            children: [
                              Padding(
                      ...
                      Row(
                        ...
                        children: [
                          Center(
                            child: Padding(
                              padding: EdgeInsets.only(
                                  top: sdp_fromPX(context, 118),
                                  left: sdp_fromPX(context, 128)),
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                        color: Color.fromRGBO(255, 255, 255, 1),
                                        fontSize: sdp_fromPX(context, 120),
                                        fontWeight: FontWeight.w700),
                                  ),
                                ),
                              ),
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      color: Color.fromRGBO(255, 255, 255, 1),
                                      fontSize: sdp_fromPX(context, 206),
                                      fontWeight: FontWeight.w700),
                                ),
                              ),
                            ),
                          ...
                          Padding(
                              padding: EdgeInsets.only(
                                  left: sdp_fromPX(context, 25))),
                          Padding(
                            padding:
                                EdgeInsets.only(top: sdp_fromPX(context, 62)),
                            child: Column(
                              children: [
                                ButtonAnimator(
                                  onTap: () {
                                    ...
                                    child: Center(
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                            color: Color.fromRGBO(
                                                255, 255, 255, 1),
                                            fontSize: sdp_fromPX(context, 80),
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            top: sdp_fromPX(context, 32),
                            left: sdp_fromPX(context, 120)),
                        child: Text(
