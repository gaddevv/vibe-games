...
import 'package:vibes_studio/elements/jackpotcard.dart';
                    ...
                    children: [
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsets.only(
                                ...
                                left: sdp_fromPX(context, 288)),
                            child: Text(
                              'Сумма ставки',
                              style: TextStyle(
                                  color: Color.fromRGBO(255, 255, 255, 0.40),
                                  fontSize: sdp_fromPX(context, 27),
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                top: sdp_fromPX(context, 29),
                                left: sdp_fromPX(context, 80)),
                            child: RichText(
                              text: TextSpan(
                                text: '777',
                                style: TextStyle(
                                    color: Color.fromRGBO(113, 56, 184, 1),
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            ...
                            left: sdp_fromPX(context, 60)),
                        child: Column(
                          children: [
                            JackpotCard(
                                image: 'assets/images/reward/reward-7.png'),
                            Padding(
                                padding: EdgeInsets.only(
                                    top: sdp_fromPX(context, 20))),
                            JackpotCard(
                                image:
                                    'assets/images/reward/reward-diamond.png'),
                            Padding(
                                padding: EdgeInsets.only(
                                    top: sdp_fromPX(context, 20))),
                            JackpotCard(
                                image: 'assets/images/reward/reward-lemon.png'),
                            Padding(
                                padding: EdgeInsets.only(
                                    top: sdp_fromPX(context, 20))),
                            JackpotCard(
                                image: 'assets/images/reward/reward-grape.png'),
                            Padding(
                                padding: EdgeInsets.only(
                                    top: sdp_fromPX(context, 20))),
                            JackpotCard(
                                image:
                                    'assets/images/reward/reward-cherry.png'),
                          ],
                        ),
                      ),
                      Padding(
                              ...
                              Center(
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      color: Color.fromRGBO(173, 0, 255, 0.05)),
                                  child: Center(
                              ...
                              decoration: InputDecoration(
                                ...
                                enabledBorder: OutlineInputBorder(
                                  ...
                                  borderSide: BorderSide(
                                      width: sdp_fromPX(context, 2),
                                      color: Color.fromRGBO(113, 56, 184, 0.4)),
                                ),
