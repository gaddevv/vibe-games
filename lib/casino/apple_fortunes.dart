...
import 'package:vibes_studio/elements/separeted_formatter.dart';
...
appleFortunes(BuildContext context) {
  ...
  double containerOffset =
      sdp_fromPX(context, 465); // Начальное смещение контейнера
  ...
  Widget buildCell(int index) {
        ...
        return Opacity(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  width: sdp_fromPX(context, 1), color: Color(0xB27137B8)),
            ),
            child: Center(
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(sdp_fromPX(context, 5)),
        border:
            Border.all(width: sdp_fromPX(context, 1), color: Color(0xB27137B8)),
      ),
      child: Center(
        child: cells[row][col] == 'apple'
            ? SvgPicture.asset(
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Padding(
                                padding: EdgeInsets.only(
                                    top: sdp_fromPX(context, 49),
                                    left: sdp_fromPX(context, 158)),
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color:
                                            Color.fromRGBO(134, 73, 212, 0.15),
                                        borderRadius: BorderRadius.circular(
                                            sdp_fromPX(context, 5))),
                                  ),
                                ),
                              ],
                            ),
                                        ...
                                        return Container(
                                          decoration: BoxDecoration(
                                            ...
                                            border: Border.all(
                                                ...
                                                color: Color(0xB27137B8)),
                                            color: cells[row][col] == 'grayed'
                                                ? Colors.grey
                                                : Color.fromRGBO(91, 59, 99, 1),
                                          ),
                                          child: Center(
                                            child: cells[row][col] == 'apple'
                                                ? SvgPicture.asset(
                                                    height:
                                                        sdp_fromPX(context, 48),
                                                    width:
                                                        sdp_fromPX(context, 48),
                                                    'assets/icons/greenapple.svg',
                                                  )
                        ...
                        Padding(
                          padding:
                              EdgeInsets.only(left: sdp_fromPX(context, 277)),
                              ...
                              Padding(
                                ...
                                child: ButtonAnimator(
                                  ...
                                  childWidget: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: activeStop
                                            ? Color.fromRGBO(184, 53, 53, 0.8)
                                            : Color.fromRGBO(184, 53, 53, 0.15),
                                        borderRadius: BorderRadius.circular(
                                            sdp_fromPX(context, 5)),
                                        border: Border.all(
                                            width: sdp_fromPX(context, 2),
